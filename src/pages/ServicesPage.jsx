      ...
      <section className="py-20 bg-white">
        <div className="container-main text-center max-w-4xl">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-brand-dark mb-6">
            Intelligence, Innovation, and Execution, Delivered Together.
          </h1>
        ...
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="neo-card p-8">
              <h3 className="text-lg font-bold text-indigo mb-5">What We Deliver</h3>
        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {serviceAreas.map((area) => (
              <div key={area.title} className="neo-card p-8">
                <div className="neo-circle w-14 h-14 mb-5 text-indigo">{area.icon}</div>
                <h3 className="text-lg font-bold text-brand-dark mb-3">{area.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {whyChoose.map((item) => (
              <div key={item} className="neo-card-sm p-5 flex items-start gap-3">
                <span className="neo-circle w-8 h-8 flex-shrink-0 text-bronze">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                </span>
