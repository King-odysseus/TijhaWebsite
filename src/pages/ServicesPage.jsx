...
const serviceAreas = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1653566031587-74f7d86a2e71?w=800&q=80&auto=format&fit=crop',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative">
              <img
                src="https://images.unsplash.com/photo-1573164574511-73c773193279?w=1000&q=80&auto=format&fit=crop"
                alt="Tijha consultants in a strategy session"
