        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {features.map((f) => (
              <div key={f.title} className="neo-card p-6">
                <div className="neo-circle w-12 h-12 text-bronze mb-4">
                  {f.icon}
                </div>
                <h3 className="text-base font-bold text-indigo mb-2">{f.title}</h3>
          ...
          <div className="relative">
            <div className="neo-card aspect-video flex items-center justify-center relative overflow-hidden">
              ...
              <button className="relative z-10 neo-circle w-16 h-16 text-bronze hover:scale-105 transition-transform">
