  ...
  return (
    <section className="w-full bg-[#F5F5F7] pt-[70px]">
      <div className="container-main py-24 md:py-32 flex flex-col items-center text-center">
        <div className="mb-8">
          <span className="inline-block neo-circle w-20 h-20 mb-6 text-bronze">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-indigo leading-tight tracking-tight mb-6">
          TIJHA
        </h1>
