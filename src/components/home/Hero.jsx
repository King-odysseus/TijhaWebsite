...
function Hero() {
  return (
    <section
      className="w-full pt-24 pb-16 md:pb-24 relative overflow-hidden"
      style={{
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="pl-8 md:pl-16">
            <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-brand-dark leading-tight mb-6">
