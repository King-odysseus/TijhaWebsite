...
function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-indigo/50 via-transparent to-indigo/70" />
      ...
      <div className="container-main relative z-10 flex flex-col items-center text-center">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-wrap gap-4 justify-center pt-10 mb-12">
          <Link
            to="/services"
          ...
          <div className="text-left">
            <div className="flex">
              {Array(5).fill(0).map((_, i) => (
                <svg key={i} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-transparent fill-bronze">
