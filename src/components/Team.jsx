const team = [
  { name: 'Sebastian Bennett', role: 'Managing Consultant', initials: 'SB' },
  { name: 'Graham Griffiths', role: 'Strategy Lead', initials: 'GG' },
  { name: 'Amelia Edwards', role: 'Operations Director', initials: 'AE' },
  { name: 'David Chen', role: 'Digital Head', initials: 'DC' },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member) => (
            <div key={member.name} className="neo-card p-8 text-center hover:-translate-y-1 transition-transform duration-300">
              <div className="neo-circle w-20 h-20 mx-auto mb-5 text-brand-blue text-xl font-bold">
                {member.initials}
              </div>
              ...
              <div className="flex justify-center gap-3">
                <a href="#" className="neo-btn w-8 h-8 flex items-center justify-center text-brand-body hover:text-brand-blue">
