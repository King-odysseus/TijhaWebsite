    ...
    <section className="section-padding bg-[#F5F5F7]">
      <div className="container-main">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-indigo mb-4">Testimonials</h2>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="neo-card p-10 text-center">
            <div className="neo-circle w-16 h-16 mx-auto mb-6 text-bronze text-lg font-bold">AE</div>
            <blockquote className="text-lg md:text-xl text-indigo leading-relaxed mb-6 italic">
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="text-left">
                <p className="font-bold text-indigo">Amelia Edwards</p>
